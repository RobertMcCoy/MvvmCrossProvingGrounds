...
{
    //[MvxRootPresentation]
    public class SecondaryViewController : MvxViewController<SecondViewModel>
    {
        ...
        public override void ViewDidLoad()
        {
            ...
            myButton.SetTitle("Go to tertiary VM", UIControlState.Normal);
            ...
            var bindingSet = this.CreateBindingSet<SecondaryViewController, SecondViewModel>();
